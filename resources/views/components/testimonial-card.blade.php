...
<div class="bg-white rounded-3xl p-8 shadow-sm border border-amber-100 hover:shadow-md transition">
    ...
    <p class="text-stone-700 italic mb-8 font-medium">"{{ $review }}"</p>
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-orange-600 font-semibold">{{ $position }}</p>
        </div>
    </div>
</div>