...
@php
    $baseClasses = 'inline-flex items-center justify-center px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-bold transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2';
    $variants = [
