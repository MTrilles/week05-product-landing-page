...
class="font-['Plus_Jakarta_Sans',sans-serif] sticky top-0 z-50 bg-gradient-to-r from-[#FFF9F2] via-[#F8EADB] to-[#EDD7BF] backdrop-blur-md border-b border-amber-900/10 shadow-sm">
        ...
        <div class="flex justify-between items-center h-20">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="/" class="flex items-center group transition-all duration-300 transform hover:scale-105">
                    <img src="{{ asset('assets/minute-burger-logo.png') }}" alt="Minute Burger Logo" class="h-14 sm:h-16 w-auto drop-shadow-[0_10px_12px_rgba(0,0,0,0.35)]">
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-1 lg:space-x-3">
                <a href="#home" 
                   ...
                   class="px-4 py-2 text-xs lg:text-sm font-bold uppercase tracking-wider rounded-full transition-all duration-200">Home</a>
                ...
                <a href="#features" 
                   ...
                   class="px-4 py-2 text-xs lg:text-sm font-bold uppercase tracking-wider rounded-full transition-all duration-200">Why Us</a>
                ...
                <a href="#franchise" 
                   ...
                   class="px-4 py-2 text-xs lg:text-sm font-bold uppercase tracking-wider rounded-full transition-all duration-200">Franchise</a>
                ...
                <a href="#testimonials" 
                   ...
                   class="px-4 py-2 text-xs lg:text-sm font-bold uppercase tracking-wider rounded-full transition-all duration-200">Reviews</a>
                ...
                <a href="#contact" 
                   ...
                   class="px-4 py-2 text-xs lg:text-sm font-bold uppercase tracking-wider rounded-full transition-all duration-200">Contact</a>
            </div>

            <!-- Action Buttons -->
            <div class="hidden md:flex items-center space-x-4">
                <a href="#login" class="px-4 py-2 text-xs lg:text-sm font-extrabold uppercase tracking-wider text-stone-800 hover:text-orange-600 transition-colors">Sign In</a>
                <a href="#order" class="inline-flex items-center gap-2.5 px-6 py-2.5 bg-gradient-to-r from-orange-500 via-orange-600 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-extrabold text-xs uppercase tracking-wider rounded-full shadow-md hover:shadow-orange-500/25 transition-all transform hover:-translate-y-0.5 active:translate-y-0">
            ...
            <div class="md:hidden flex items-center">
                <button @click="open = !open" class="p-2 rounded-xl text-stone-800 hover:bg-orange-500/10 focus:outline-none transition">
    ...
    <div x-show="open" x-collapse class="md:hidden bg-[#FFF9F2]/98 border-t border-amber-900/10 px-4 pt-4 pb-6 space-y-2 shadow-xl">
